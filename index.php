  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link text-light" href="cart.php"><i class="fa-solid fa-cart-shopping"></i></i><sup><?php cart_item();?></sup></a>
        </li>
        <li class="nav-item">
...
<nav class="navbar navbar-expand-lg bg-dark">
    ...
    <li class="nav-item">
          <a class="nav-link text-light" href="admin/index.php">Administrare</a>
    </li>
    </ul>
</nav>
